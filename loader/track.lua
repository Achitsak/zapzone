...
if gameId == 7436755782 then -- grow a garden
    ...
    getgenv().Hermanos_Settings = {
        ...
        ['Seeds'] = {"Poseidon Plant","Romanesco","Gleamroot","Princess Thorn","Amberheart","Pricklefruit","Bitter Melon","Veinpetal","Veinpetal","Golden Egg","Veinpetal","Grand Tomato","EnTall Asparaguskaku","Sugarglaze","EnkaCrown Melonku","Taco Fern","Twisted Tangle","Elder Strawberry","Dragon Pepper","Maple Apple","Hinomai","Zen Rocks","King Cabbage","Elephant Ears","Wild Carrot","Pear","Cantaloupe","Parasol Flower","Rosy Delight","Elephant Ears","Ember Lily","Honeysuckle","Lumira","Dandelion","Nectarshade","Manuka Flower","Lavender","Sunflower","Beanstalk","Grapes","Mango","Cactus","Cherry Blossom","Moon Blossom","Candy Blossom","Delphinium","Lily of the Valley","Aloe Vera","Guanabana","White Mulberry","Peace Lily","Pitcher Plant","Burning Bud","Rafflesia","Liberty Lily","Firework Flower","Sugar Apple","Moon Mango","Blood Banana","Moon Melon","Traveler's Fruit","Beanstalk","Cherry Blossom","Candy Sunflower","Moonflower","Moon Mango","Bone Blossom","Fossilight","Firefly Fern","Boneboo","Horned Dinoshroom","Paradise Petal","Paradise Petal","Feijoa","Cacao","Pepper","Giant Pinecone","Grand Volcania","Sinisterdrip","Veinpetal","Twisted Tangle","Dezen","Lucky Bamboo","Tranquil Bloom","Enkaku","Sakura Bush"},
        ['Pets'] = {"Spriggan","Golden Goose","Golem","Hotdog Daschund","Bagel Bunny","Bacon Pig","Gorilla Chef","Lobster Thermidor","Sapling","Mochi Mouse","Bagel Bunny","Pancake Mole","Sushi Bear","Spaghetti Sloth","French Fry Ferret","Corrupted Kodama","Kiwi","Raiju","Shiba Inu","Nihonzaru","Tanuki","Sunny-Side Chicken","Kappa","Kitsune","Panda","Capybara","Ostrich","Bunny","Disco Bee","Queen Bee","Crab","Toucan","Deer","Red Giant Ant","Honey Bee","Monkey","Squirrel","Petal Bee","Starfish","Mole","Chicken","Echo Frog","Dragonfly","Raccoon","Seagull","Snail","Flamingo","Blood Kiwi","Owl","Spotted Deer","Golden Lab","Orangutan","Frog","Pack Bee","Cooked Owl","Red Dragon","Cow","Mimic Octopus","Praying Mantis","Caterpillar","Turtle","Dog","Bear Bee","Moth","Night Owl","Golden Bee","Peacock","Firefly","Giant Ant","Blood Hedgehog","Cat","Sea Turtle","Black Bunny","Brown Mouse","Butterfly","Silver Monkey","Tarantula Hawk","Wasp","Bee","Orange Tabby","Moon Cat","Blood Owl","Seal","Chicken Zombie","Red Fox","Grey Mouse","Hedgehog","Sea Otter","Scarlet Macaw","Polar Bear","Pig","Rooster","Meerkat","Axolotl","Hamster","Fennec Fox","Sand Snake","Hyacinth Macaw","Bald Eagle","T-Rex","Brontosaurus","Raptor","Triceratops","Spinosaurus","Ankylosaurus","Dilophosaurus","Pachycephalosaurus","Iguanodon","Pterodactyl","Corrupted Kitsune","Raiju","Kodama","Maneki-neko","Tsuchinoko","Mizuchi","Koi"},
        ['Gears'] = {"Silver Fertilizer","Grandmaster Sprinkler","Recall Wrench","Harvest Tool","Advanced Sprinkler","Master Sprinkler","Trowel","Friendship Pot","Lightning Rod","Godly Sprinkler","Watering Can","Basic Sprinkler","Level Up Lollipop"},
        ['Eggs'] = {"Sprout Egg","Gourmet Egg","Rare Summer Egg","Zen Egg","Paradise Egg","Epic Egg", "Divine Egg", "Rare Egg", "Uncommon Egg", "Legendary Egg", "Exotic Bug Egg", "Common Egg", "Bug Egg", "Night Egg", "Premium Night Egg", "Mythical Egg", "Bee Egg", "Premium Anti Bee Egg", "Anti Bee Egg", "Oasis Egg", "Dinosaur Egg"}
...
elseif gameId == 1451439645 then -- king legacy
    ...
    getgenv().Hermanos_Settings = {
        ...
        ['Swords'] = {"Phoenix Blade", "Kioru V2", "Hunter Blade", "Avalon", "Acrospear", "Muramasa", "Scepters of Flame","Sonata","Dark Blade","Kioru","Metal Trident","Muramasa", "Bloodmoon Twins", "Longaevus", "Acroscyth", "Riptide Slayer", "Saber", "Abyssal Crab Axe", "Dawnbreaker", "Ethereal", "Authentic Triple Katana", "Bone Scythe"},
